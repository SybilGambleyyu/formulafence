...
palette colour, viewport geometry, final visibility, print settings,
extension-specific view behavior, or client state. The boundary follows the Open XML SDK
