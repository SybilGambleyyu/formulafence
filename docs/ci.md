...
## Shared external-workbook-link, formula-action, Python-in-Excel, custom-function, runtime, registration, XLM-evaluation, and XLM-action artifacts
...
XLM registration, evaluation, and action boundaries, so set the relevant inputs when a shared artifact
  ...
  formulafence:
    ...
    steps:
      ...
      - run: >-
          ...
          https://github.com/SybilGambleyyu/formulafence/releases/download/v0.106.0/formulafence-0.106.0-py3-none-any.whl
      - run: >-
          formulafence check
