...
## Shared external-workbook-link, formula-action, Python-in-Excel, custom-function, runtime, registration, XLM-evaluation, XLM-action, and XLM-GET.CELL artifacts
...
XLM registration, evaluation, action, and GET.CELL boundaries, so set the relevant inputs when a shared artifact
  ...
  formulafence:
    ...
    steps:
      ...
      - run: >-
          ...
          https://github.com/SybilGambleyyu/formulafence/releases/download/v0.107.0/formulafence-0.107.0-py3-none-any.whl
      - run: >-
          formulafence check
