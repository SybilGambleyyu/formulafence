...
## Shared external-workbook-link, formula-action, Python-in-Excel, custom-function, runtime, registration, and XLM-evaluation artifacts
...
XLM registration and evaluation boundaries, so set the relevant inputs when a shared artifact
  ...
  formulafence:
    ...
    steps:
      ...
      - run: >-
          ...
          https://github.com/SybilGambleyyu/formulafence/releases/download/v0.105.0/formulafence-0.105.0-py3-none-any.whl
      - run: >-
          formulafence check
