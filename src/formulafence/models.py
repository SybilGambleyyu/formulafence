...
class DiffReport:
    ...
    # only aggregate boundary evidence, while shared-artifact rendering can use
    # exact source cells to hide a static value even when dependency samples
    # were truncated before the guarded consumer.
    ...
    formula_defined_xlm_evaluation_static_input_cells: frozenset[CellKey] = field(
        default_factory=frozenset, repr=False
    )
    formula_defined_xlm_action_static_input_cells: frozenset[CellKey] = field(
        default_factory=frozenset, repr=False
    )
    formula_defined_xlm_get_cell_static_input_cells: frozenset[CellKey] = field(
        default_factory=frozenset, repr=False
    )
    formula_defined_xlm_environment_information_static_input_cells: frozenset[
        CellKey
    ] = field(default_factory=frozenset, repr=False)
    formula_environment_information_static_input_cells: frozenset[CellKey] = field(
        default_factory=frozenset, repr=False
    )
