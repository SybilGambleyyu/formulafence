...
def test_lint_invalid_text_literal_argument_is_high(tmp_path) -> None:
    workbook_path = tmp_path / "text-literal-argument.xlsx"
    workbook = Workbook()
    worksheet = workbook.active
    worksheet.title = "Model"
    worksheet["B2"] = "=MID(C2,0,-1)"
    workbook.save(workbook_path)
...
def test_lint_direct_zero_divisor_is_high(tmp_path) -> None:
    workbook_path = tmp_path / "direct-zero-divisor.xlsx"
    workbook = Workbook()
    worksheet = workbook.active
    worksheet.title = "Model"
    worksheet["B2"] = "=C2/0"
...
def test_lint_mod_literal_zero_divisor_is_high(tmp_path) -> None:
    workbook_path = tmp_path / "mod-literal-zero-divisor.xlsx"
    workbook = Workbook()
    worksheet = workbook.active
    worksheet.title = "Model"
    worksheet["B2"] = "=MOD(C2,0)"
    workbook.save(workbook_path)
...
def test_lint_date_function_literal_code_is_high(tmp_path) -> None:
    workbook_path = tmp_path / "date-function-literal-code.xlsx"
    workbook = Workbook()
    worksheet = workbook.active
    worksheet.title = "Model"
    worksheet["B2"] = "=WEEKNUM(C2,0)"
    workbook.save(workbook_path)
...
def test_lint_saved_divide_by_zero_result_is_high(tmp_path) -> None:
    workbook_path = make_formula_cached_result_model(
...
def test_lint_saved_numeric_error_result_is_high(tmp_path) -> None:
    workbook_path = make_formula_cached_result_model(
...
def test_lint_saved_value_error_result_is_high(tmp_path) -> None:
    workbook_path = make_formula_cached_result_model(
...
def test_lint_saved_null_intersection_error_result_is_high(tmp_path) -> None:
    workbook_path = make_formula_cached_result_model(
